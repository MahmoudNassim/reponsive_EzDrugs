...
class RegisterDr extends StatefulWidget {
  const RegisterDr({super.key});
  static const RouteName = 'RegisterDr';

  @override
  State<RegisterDr> createState() => _RegisterDrState();
}

class _RegisterDrState extends State<RegisterDr> {
